...
export default function UserDetail() {
  ...
  return (
    <ScrollView scrollY className='user-page public-page' showScrollbar={false} enhanced bounces={false}>
      <View className='nav-bar' style={{ paddingTop: `${statusBarHeight + 10}px` }}>
        <Text className='back-icon' style={{ top: `${statusBarHeight + 10}px` }} onClick={() => Taro.navigateBack()}>‹</Text>
        {!isSelf && (
          <View className='more-menu' style={{ top: `${statusBarHeight + 8}px` }} onClick={showMore}>
            <Text>...</Text>
          </View>
        )}
      </View>
