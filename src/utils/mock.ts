...
export const USER_DETAILS: Record<string, any> = {
  ...
  '研机达人': {
    id: 'u_research', name: '研机达人', avatar: '', bgCover: 'linear-gradient(135deg, #2563EB 0%, #60A5FA 100%)',
    college: '计算机学院', grade: '研一', verified: true,
  ...
  '代码小白': {
    id: 'u_code', name: '代码小白', avatar: '', bgCover: 'linear-gradient(135deg, #06B6D4 0%, #2563EB 100%)',
  ...
  '材料人': {
    id: 'u_material', name: '材料人', avatar: '', bgCover: 'linear-gradient(135deg, #10B981 0%, #14B8A6 100%)',
  ...
  '王同学': {
    id: 'u_review_1', name: '王同学', avatar: '', bgCover: 'linear-gradient(135deg, #3B82F6 0%, #1D4ED8 100%)',
  ...
  '李学姐': {
    id: 'u_review_2', name: '李学姐', avatar: '', bgCover: 'linear-gradient(135deg, #8B5CF6 0%, #6366F1 100%)',
  ...
  '羽毛球搭子': {
    id: 'u_review_4', name: '羽毛球搭子', avatar: '', bgCover: 'linear-gradient(135deg, #F59E0B 0%, #F97316 100%)',
