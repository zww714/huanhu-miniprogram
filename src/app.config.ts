export default defineAppConfig({
  ...
  subpackages: [
    { root: 'sp-common/', pages: ['pages/login/index','pages/verify/index','pages/search-results/index'] },
